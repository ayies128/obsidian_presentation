...
```mermaid
graph LR
    A[💻 PC] <-->|☁️ Obsidian Sync| B[🌐 クラウド]
    B <-->|☁️ Obsidian Sync| C[📱 モバイル]
    A -->|📤 定期commit| D[🐙 GitHub]
```

1. 普段は **☁️ Obsidian Sync** でリアルタイム同期
...
1. ⚙️ Obsidian の設定 → コアプラグイン → **Sync を有効化**
2. 🔑 Obsidian アカウントでログイン
3. ☁️ **リモートVaultを作成**または既存を選択
4. ✨ 同期開始！
